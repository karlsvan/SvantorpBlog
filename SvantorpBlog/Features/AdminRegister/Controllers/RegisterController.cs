...
using SvantorpBlog.Features.AdminRegister.Models;

namespace SvantorpBlog.Features.AdminRegister.Controllers
{
    /// <summary>
    ...
    public class RegisterController : Controller
    {
        ...
        {
            return View("~/Features/AdminRegister/Views/register.cshtml");
        }
